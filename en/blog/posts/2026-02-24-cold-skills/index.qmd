...
I've been experimenting with ideas that revolve around this skills as packages approximation and I like the current results enough that I want to talk about it, if only to read it back again in a few months and see how bad this take is. My current take on this is [akm - the agent kit manager](https://github.com/akm-rs/akm)
...
## My take : `akm`, the [agent kit manager](https://github.com/akm-rs/akm)
