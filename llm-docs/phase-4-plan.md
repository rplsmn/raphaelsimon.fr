...
2. Implement logic:
     ...
     - If `translation == "machine"`:
       ...
       - Render banner HTML:
         ...
         <div class="translation-banner">
           <p>
             <strong>Machine-translated</strong> — Original in: 
             <a href="/fr/blog/posts/slug/">🇫🇷</a>
           </p>
         </div>
         ```
   ...
   - Banner text per language:
     - English: "Machine-translated — Original in: {flags}"
     - French: "Traduit automatiquement — Original en : {flags}"
...
- Flag emoji matches language (🇫🇷 for French, 🇬🇧 for English)
...
- Banner text is in French: "Traduit automatiquement — Original en :"
- Banner includes link to English version with 🇬🇧 flag
...
**Decision Point:**
- If **global search** detected: Proceed to Tasks 12 → 13 → 15 (add language indicators to results)
- If **per-language search** detected: Skip Tasks 12-13, proceed to Task 14 → 15 (document behavior)
...
5. Verify:
   ...
   - English results have 🇬🇧 flag
   - French results have 🇫🇷 flag
